...
<template>
  <div
    class="window-width window-height flex justify-center items-center"
  ...
  >
    <q-card class="recoverCard" flat>
      ...
      <q-card-section v-if="resetStatus == 1">
        <div
          style="width: 100%"
          class="flex justify-center column items-center q-pa-md"
        >
          <q-img
            src="~assets/img/app/passwordReset/reset-1.png"
            style="width: 100px"
          />
      ...
      <q-card-section v-if="resetStatus == 3">
        ...
        >
          <q-img
            src="~assets/img/app/passwordReset/reset-2.png"
            style="width: 100px"
          />
          <span class="text-subtitle1 text-center text-bold text-secondary">
